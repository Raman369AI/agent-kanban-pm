...
from agent_kanban_pm.schemas import AgentConnectionCreate, AgentConnectionResponse
from agent_kanban_pm.auth import get_current_entity, require_worker, require_manager, is_owner_or_manager
