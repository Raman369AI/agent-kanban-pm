...
class AgentSession(Base):
    ...
    review_base_revision = Column(String(64), nullable=True)
...
class AgentCheckpoint(Base):
    """Durable resume point for a task-scoped CLI agent session."""
...
class DiffReview(Base):
    ...
    work_revision = Column(String(64), nullable=True)
    base_revision = Column(String(64), nullable=True)
